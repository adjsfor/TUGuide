...
#import "CreateUserExistingMail.h"


@implementation CreateUserExistingMail

@synthesize server,create;

- (void) createUserTest {
	[self helperCreateMethodWithName:@"user2" andMail:@"test@tuwien.at" andPassword:@"XX"];
}
