//
//  CreateUserExistingScreenName.m
//  TUGuide
//
...
#import "CreateUserExistingScreenName.h"


@implementation CreateUserExistingScreenName

@synthesize server,create;

- (void) createUserTest {
	[self helperCreateMethodWithName:@"testingUser" andMail:@"XX@tuwien.at" andPassword:@"XX"];
}
